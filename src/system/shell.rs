...
pub enum ShellError {
    ...
    #[error("No se pudo encontrar el directorio de configuración de axes.")]
    ConfigDirNotFound,
    #[error("La shell solicitada '{0}' no está definida en shells.toml.")]
    ...
    #[error("Error al serializar la configuración de shells a TOML: {0}")]
